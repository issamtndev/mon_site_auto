...
use App\HomeBundle\Entity\Marque;
use App\HomeBundle\Form\MarqueType;
...
class MarqueController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('HomeBundle:Marque')->findAll();

        return $this->render('HomeBundle:Marque:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('HomeBundle:Marque:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('HomeBundle:Marque')->find($id);
        ...
        return $this->render('HomeBundle:Marque:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('HomeBundle:Marque:edit.html.twig', array(
            'entity'      => $entity,
